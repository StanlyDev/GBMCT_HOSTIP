...
--
-- Servidor: localhost
-- Tiempo de generación: 18-06-2024 a las 07:38:04
...
(1, 'Root', '$2y$10$8pUcRG8HbGvXYMZOczP2eOdUd0Wp9gpo.gefQMaGpCfmxyBOx.MTK', 'root', 'r@root.com', 0, NULL),
(3, 'Operador', 'GBM123', 'operator', 'o@operator.com', 1, NULL),
(6, 'Admin', 'GBM123', 'admin', 'a@admin.com', 1, NULL),
...
(30, 'Brandon Ventura', 'GBM123', 'operator', 'bventura@gbm.net', 1, NULL),
