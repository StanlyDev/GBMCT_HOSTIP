...
<body>
  ...
  <header>
    ...
    <div class="close_user"><a href="/index.html"><script src="https://cdn.lordicon.com/lordicon.js"></script>
      ...
      <div class="Add_Invent"><a href="/Pages/AddInvent.html"><script src="https://cdn.lordicon.com/lordicon.js"></script>
  ...
  <main>
    ...
    <div class="Info_Cinta">
      ...
      <p style="padding-left: 40px;">En Cintoteca: </p>
  ...
  <footer>
    <div class="botones-container">
      <button onclick="descargarExcel()">
        <img src="/IMG/Icon/file-earmark-excel-fill.svg">
        <img src="/IMG/Icon/file-earmark-excel.svg"><p>Descargar Excel</p>
      </button>
    </div>
  </footer>
  <script>
